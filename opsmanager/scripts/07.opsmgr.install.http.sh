...
cat /opt/mongodb/mms/conf/conf-mms.properties | sed 's#mongoUri=.*$#mongoUri=mongodb://superuser:secret@ip-172-31-6-17.us-west-2.compute.internal:27000,ip-172-31-8-235.us-west-2.compute.internal:27000,ip-172-31-9-51.us-west-2.compute.internal:27000/?authSource=admin\&replicaSet=rsAppDB\&maxPoolSize=150#g' | sudo tee /opt/mongodb/mms/conf/conf-mms.properties
