...
awsInstanceTagName="ska-ors-rhel72"
awsSSHUser="ec2-user"
...
rs.initiate({_id: "rsOplogStore", "members" : [{ "_id" : 0, "host" : "${privateDNSNames[1]}:27001"}]})
sleep(10000)
...
cat /opt/mongodb/mms/conf/conf-mms.properties | sed 's#mongo\.mongoUri=.*#mongo.mongoUri=mongodb://superuser:secret@${privateDNSNames[0]}:27000,${privateDNSNames[1]}:27000,${privateDNSNames[2]}:27000/?authSource=admin&replicaSet=rsAppDB&maxPoolSize=150#g' | sudo tee /opt/mongodb/mms/conf/conf-mms.properties
...
# user: superuser
# password: secret
# servers: ${privateDNSNames[0]}:27001,${privateDNSNames[1]}:27001,${privateDNSNames[2]}:27001
# options: authSource=admin&replicaSet=rsAppDB&maxPoolSize=150
CONFIGBACKUP
...
mmsGroupId=588a07c22119e9796720ace5
...
tee "$scriptsFolder/11.opsmgr.install.pool.sh" <<INSPOOL
###############################################################
