...
createServerCertificate()
{
    ...
    openssl x509 -req -passin pass:$cpass -days 365 -in $scpath/$sname.csr -CA $cpath/rootca.public.crt -CAkey $cpath/rootca.private.key -set_serial 01 -out $scpath/$sname.public.crt
